...
export function PlayerSelectButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={[
        'flex h-[68px] w-full shrink-0 items-center gap-[4px] overflow-clip rounded-[8px] bg-white text-left',
    ...
    >
      <div className="flex h-full flex-1 items-center gap-3 overflow-hidden px-3">
        ...
        <div className="flex shrink-0 items-center justify-center p-[2px]">
          <div className="relative h-7 w-7 overflow-hidden rounded-full bg-[#4e4743]">
            <img
              src={playerImgUrl}
              alt={playerName}
        ...
        {/* Team logo on the right of text */}
        {teamImgUrl && (
