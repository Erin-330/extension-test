...
## 알려진 peer dependency 경고 (무시 가능)

설치 시 아래 경고가 표시되지만 실제 빌드·동작에는 영향 없다.

```
@storybook/react-vite — vite@^4-6 기대, vite@8 설치됨
@testing-library/react — @testing-library/dom@^10 기대 → 별도 설치로 해결됨
```
